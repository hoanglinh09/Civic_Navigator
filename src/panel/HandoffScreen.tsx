export function HandoffScreen({ variant }: { variant: "login" | "data" }) {
  ...
  return (
    <div className="absolute inset-0 bg-white/80 backdrop-blur-sm flex items-center justify-center p-6">
      <div className="w-full max-w-xs rounded-2xl bg-white border border-slate-200 shadow-lg p-5 text-center">
